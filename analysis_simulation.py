...
def plot_trend_char3(y1_mean, y2_mean, y3_mean, x_str, y_str, model_1, model_2, model_3):
    ...
    plt.errorbar(ind, y3_mean, fmt='b-^', linewidth=4, markersize=10, markerfacecolor='w', markeredgewidth=3)
    plt.xticks(ind, label)
    plt.legend([model_1, model_2, model_3], fontsize=legend_fontsize)
    plt.grid(True)
    plt.xlabel(x_str, fontsize=label_fontsize)
...
def plot_trend_char4(y1_mean, y2_mean, y3_mean, y4_mean, x_str, y_str, model_1, model_2, model_3, model_4):
    ...
    plt.errorbar(ind, y3_mean, fmt='b-^', linewidth=4.5, markersize=10, markerfacecolor='w', markeredgewidth=3)
    plt.errorbar(ind, y4_mean, fmt='y-o', linewidth=4.5, markersize=10, markerfacecolor='w', markeredgewidth=3)
    plt.xticks(ind, label)
    plt.legend([model_1, model_2, model_3, model_4], fontsize=legend_fontsize)
    plt.grid(True)
    plt.xlabel(x_str, fontsize=label_fontsize)
    plt.ylabel(y_str, fontsize=label_fontsize)
    plt.show()
...
def plot_trend_char5(y1_mean, y2_mean, y3_mean, y4_mean, y5_mean, x_str, y_str, model_1, model_2, model_3, model_4, model_5):
    ...
    plt.xticks(ind, label)
    plt.legend([model_1, model_2, model_3, model_4, model_5], fontsize=legend_fontsize)
    plt.grid(True)
    plt.xlabel(x_str, fontsize=label_fontsize)
    plt.ylabel(y_str, fontsize=label_fontsize)
    plt.show()
...
def plot_trend_error_char3(y1_mean, y2_mean, y3_mean,
    ...
    plt.errorbar(ind, y3_mean, yerr=y_error3, fmt='b-', linewidth=2, markersize=10, markerfacecolor='w', markeredgewidth=3)
...
def plot_trend_error_char5(y1_mean, y2_mean, y3_mean, y4_mean, y5_mean,
    ...
    plt.errorbar(ind, y3_mean, yerr=y_error3, fmt='b-', linewidth=2, markersize=5, markerfacecolor='w', markeredgewidth=3)
