...
scipy.io.savemat("./result_mat/total_driver_payoffs.mat", mdict={"random_mean": u5_mean, "random_std": u5_std,
...
scipy.io.savemat("./result_mat/platform_profit.mat", mdict={"random_mean": p5_mean, "random_std": p5_std,
